sap.ui.define([
		...
		return UIComponent.extend("zsdcamppartners.Component", {
			...
			init : function () {
				...
				// var oMandatoryBrandMaterial = new JSONModel(sPath);
				// this.setModel(oMandatoryBrandMaterial, "mandatoryBrandMaterial");
