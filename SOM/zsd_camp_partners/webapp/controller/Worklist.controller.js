sap.ui.define([
		...
		"zsdcamppartners/model/formatter",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"zsdcamppartners/model/ODataCalls"		
	], function (BaseController, JSONModel, History, formatter, Filter, FilterOperator,ODataCalls) {
		"use strict";

		return BaseController.extend("zsdcamppartners.controller.Worklist", {
			...
			onDataExport : function (oEvent){
				this.getOwnerComponent().ODataCallsObj.onDataExportShipTo();
			},
