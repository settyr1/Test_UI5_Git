sap.ui.define([
		...
		"zsdcamppartners/factory/SearchHelpFactory",
		"zsdcamppartners/factory/SearchHelpResultColumn",
		"zsdcamppartners/factory/SearchHelpResults",
		...
		return Controller.extend("zsdcamppartners.controller.BaseController", {
			/**
...
//following function will give all entity properties so you can prepare filters
			...
			if (!this._searchView) {
				this._searchView = sap.ui.xmlfragment("id_View_SearchHelp", "zsdcamppartners.SearchHelp.DynamicSearchSelection",
							this);
