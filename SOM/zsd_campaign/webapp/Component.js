sap.ui.define([
		...
		return UIComponent.extend("zsdcampaign.Component", {
			...
			init : function () {
				...
				var omandatoryCampaign = new JSONModel(sPath);
				this.setModel(omandatoryCampaign, "mandatoryCampaign");
				
				var sPath2 = jQuery.sap.getModulePath("zsdcampaign", "/model/mandatoryCampaignDetails.json");
				var omandatoryCampaignDetails = new JSONModel(sPath2);
				this.setModel(omandatoryCampaignDetails, "mandatoryCampaignDetails");
			},
