sap.ui.define([
		...
		return BaseController.extend("zsdcampaign.controller.Worklist", {
...
window.location.href = aURLparts[1];
			 ...
			 */
			 onRowChange: function(oEvent){
			   var vPath = oEvent.getParameter("rowContext").sPath;
			   var vCampId = oEvent.getParameter("rowContext").getModel('JMDL').getProperty(vPath).CampId;
			...
			_showObject : function (oItem) {
				this.getRouter().navTo("object", {
					objectId: oItem.getBindingContext().getProperty("CampId")
				});
			},
