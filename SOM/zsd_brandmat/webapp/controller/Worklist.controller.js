sap.ui.define([
		...
		"zsdbrandmat/model/formatter",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"zsdbrandmat/model/ODataCalls"		
	], function (BaseController, JSONModel, History, formatter, Filter, FilterOperator,ODataCalls) {
		"use strict";

		return BaseController.extend("zsdbrandmat.controller.Worklist", {
			...
			onInit : function () {
				...
				this.getOwnerComponent().ODataCallsObj.readEntitySet('BrandMaterialSet');
				this.setModel(this.getOwnerComponent().ODataCallsObj.getJsonModel(), "BRANDS");
