sap.ui.define([
		...
		"zsdbrandmat/factory/SearchHelpFactory",
		"zsdbrandmat/factory/SearchHelpResultColumn",
		"zsdbrandmat/factory/SearchHelpResults",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator"		
	], function (Controller, SearchHelpFactory, SearchHelpResultColumn, SearchHelpResults,Filter,FilterOperator) {
		"use strict";

		return Controller.extend("zsdbrandmat.controller.BaseController", {
			/**
...
//following function will give all entity properties so you can prepare filters
			...
			entityMetadata.some(function(oLine){
				...
				if( lSearchService &&lSearchService.replace("Set","") === oLine.name){
			...
			if (!this._searchView) {
				this._searchView = sap.ui.xmlfragment("id_View_SearchHelp", "zsdbrandmat.SearchHelp.DynamicSearchSelection",
							this);
