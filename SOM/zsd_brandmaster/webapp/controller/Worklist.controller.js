sap.ui.define([
		...
		return BaseController.extend("zsdbrandmaster.controller.Worklist", {
			...
			onInit : function () {
				...
				this.getOwnerComponent().ODataCallsObj.readEntitySet('BrandsSet');
			...
			onDataExport : function (oEvent){
				this.getOwnerComponent().ODataCallsObj.onDataExportBrandsSet();
			},
