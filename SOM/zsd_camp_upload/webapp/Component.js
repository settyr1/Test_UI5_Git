sap.ui.define([
		...
		return UIComponent.extend("zsdcampupload.Component", {
			...
			init : function () {
				...
				// var sPath = jQuery.sap.getModulePath("zsdcampupload", "/model/fileAttributes.json");
				// var oFile = new JSONModel(sPath);
				// this.setModel(oFile, "fileMDL");

				var sPath1 = jQuery.sap.getModulePath("zsdcampupload", "/model/mandatoryFields.json");
				var oFile1 = new JSONModel(sPath1);
				this.setModel(oFile1, "mandatoryFields");
