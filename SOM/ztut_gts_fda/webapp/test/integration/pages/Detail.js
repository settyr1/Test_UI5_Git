						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("GuidChar");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.GuidChar === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsHeader",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<PgeneralToPPG19PG20Plural> (" + iNumberOfItems + ")"}),
								success : function () {
