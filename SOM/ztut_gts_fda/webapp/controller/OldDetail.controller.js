...
sap.ui.define([
	...
	], function (BaseController, JSONModel, formatter, fdaDataCalls) {
		"use strict";

		return BaseController.extend("com.pfizer.fda.controller.Detail", {
			...
			_onObjectMatched : function (oEvent) {
				...
				this.fdaModelObj = new fdaDataCalls(	this.getModel(),
														this.getModel("detailView"),
														this.getOwnerComponent(),
														this.getModel("i18n").getResourceBundle()
												);
				
				this.setModel(this.fdaModelObj.getJsonModel(), "FDA");
				
				this.fdaModelObj.readFdaExpand(sObjectId);
